...
const Intro = () => {
  ...
  const slides = [
    {
      key: 1,
      title: 'Search for a medics',
      text: 'Start by searching for a qualified nurse. Find your caring staff here.',
      image: require('.././assets/json/slider_1.json'),
      bg: colors.theme_bg_three,
    },
    {
      key: 2,
      title: 'Check for a rating',
      text: 'Only highly rated nurses are allowed in our system.',
    ...
    },
    {
      ...
      text: 'With the helping hands available.',
