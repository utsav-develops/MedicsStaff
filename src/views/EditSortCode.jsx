...
const EditSortCode = (props) => {
    ...
    const check_valid = () => {
        if (sort_code) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your Sort code');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            data: { staff_id: global.id, sort_code: sort_code }
        })
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', 'Successfully updated', 'Your Sort code has been updated.');
                go_back();
            })
            .catch(error => {
                setLoading(false);
    ...
    <>
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontWeight: 'bold' }}>Enter your Sort code</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontWeight: 'normal' }}>You need enter your Sort code</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
