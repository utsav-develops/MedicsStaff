  ...
  return (
    ...
    />
        ...
        <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
              <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontWeight: 'bold' }}>{t('uploadYourDocument')}</Text>
          </View>
      </View>
      ...
      {upload_status == 0 ?
        <View style={{ padding: 10 }}>
          ...
          <View>
            ...
            <TouchableOpacity onPress={move_to_upload.bind(this, 'id_proof', id_proof.status, id_proof.path)} activeOpacity={1} style={{ borderWidth: 1, padding: 10, borderRadius: 5, borderStyle: 'dashed', flexDirection: 'row' }}>
              <View style={{ width: '70%' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>{t('uploadIdProof')}</Text>
              </View>
              <View style={{ width: '30%', alignItems: 'center', justifyContent: 'center' }}>
                <Image source={id_proof.path} style={{ height: 75, width: 75, borderRadius:10, }} />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View>
            ...
            <TouchableOpacity onPress={move_to_upload.bind(this, 'speciality_image', speciality_image.status, speciality_image.path)} activeOpacity={1} style={{ borderWidth: 1, padding: 10, borderRadius: 5, borderStyle: 'dashed', flexDirection: 'row' }}>
              <View style={{ width: '70%' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>{t('uploadPicture')}</Text>
              </View>
              <View style={{ width: '30%', alignItems: 'center', justifyContent: 'center' }}>
                <Image source={speciality_image.path} style={{ height: 75, width: 75, borderRadius:10, }} />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View>
            ...
            <TouchableOpacity onPress={move_to_upload.bind(this, 'speciality_certificate', speciality_certificate.status, speciality_certificate.path)} activeOpacity={1} style={{ borderWidth: 1, padding: 10, borderRadius: 5, borderStyle: 'dashed', flexDirection: 'row' }}>
              <View style={{ width: '70%' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>{t('uploadRegistrationCertificate')}</Text>
              </View>
              <View style={{ width: '30%', alignItems: 'center', justifyContent: 'center' }}>
                <Image source={speciality_certificate.path} style={{ height: 75, width: 75, borderRadius:10, }} />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View>
            <Text style={{ fontWeight: 'bold', color: colors.theme_fg_two, fontSize: f_l }}>
                {t('nmcRegistrationCertificate')}          </Text>
            <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>
              {t('makeSureClearlyVisible')}
            </Text>
            <View style={{ margin: 10 }} />
            <TouchableOpacity onPress={move_to_upload.bind(this, 'speciality_insurance', speciality_insurance.status, speciality_insurance.path)} activeOpacity={1} style={{ borderWidth: 1, padding: 10, borderRadius: 5, borderStyle: 'dashed', flexDirection: 'row' }}>
              <View style={{ width: '70%' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>{t('uploadNMCcertificate')}</Text>
              </View>
              <View style={{ width: '30%', alignItems: 'center', justifyContent: 'center' }}>
                <Image source={speciality_insurance.path} style={{ height: 75, width: 75, borderRadius:10, }} />
              </View>
            </TouchableOpacity>
          </View>
