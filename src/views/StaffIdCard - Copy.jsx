...
import { bold, api_url, get_profile, img_url, f_xl, get_specialities,get_staff_rating, work_request_details, booking_completion_details, speciality_type_list, work_details } from '../config/Constants';
          ...
          {on_load === 1 && (
              <View style={styles.contentContainer}>
                  ...
                  <View style={styles.profileImageContainer}>
                      <Image style={styles.profileImage} source={{ uri: img_url + data.profile_picture }} />
                  </View>
                  {/* Name and Job Title */}
