...
import { bold, api_url, image_upload, img_url, update_document, btn_loader, f_m, screenHeight, screenWidth } from '../config/Constants';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{  alignItems: 'center', justifyContent: 'center', flex:1,marginBottom:40, }}>
        <View style={{ height: '100%', width: '100%', padding:20, }}>
          <Image source={path} style={{ height:'100%', width:'100%',borderRadius:20,}} />
        </View>
        <View style={{ margin: 10 }} />
        {status == 14 &&
