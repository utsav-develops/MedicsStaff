...
const KycVerification = (props) => {
  ...
  const check_validation = () => {
    if (bank_name == "" || account_number == "" || sort_code == "") {
  ...
  const call_update_kyc = () => {
    ...
    axios({
      ...
      data: { staff_id: global.id, bank_name: bank_name, bank_account_number: account_number, sort_code: sort_code, aadhar_number: aadhar_number, pan_number: pan_number }
    })
      .then(async response => {
        setLoading(false);
            ...
            <ScrollView>
              <View style={{ alignItems: 'center' }}>
                ...
                <View style={{ width: '90%' }}>
                  ...
                  <View style={{ marginBottom: 20 }}>
                    <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>{t('AccName')}</Text>
                    <View style={{ margin: 5 }} />
                    <TouchableOpacity activeOpacity={1} style={{ flexDirection: 'row' }}>
                      <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg_three }}>
                  ...
                  <View style={{ marginBottom: 20 }}>
                    <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>Merchant Name (Esewa / Khalti)</Text>
                    <View style={{ margin: 5 }} />
                    <TouchableOpacity activeOpacity={1} style={{ flexDirection: 'row' }}>
                      <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg_three }}>
                        <Icon type={Icons.AntDesign} name="bank" color={colors.theme_fg_two} style={{ fontSize: 30 }} />
                      </View>
                      <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                        <TextInput
                          value={aadhar_number}
                  ...
                  <View style={{ marginBottom: 20 }}>
                    ...
                    <TouchableOpacity activeOpacity={1} style={{ flexDirection: 'row' }}>
                      <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg_three }}>
                        <Icon type={Icons.Entypo} name="phone" color={colors.theme_fg_two} style={{ fontSize: 30 }} />
                      </View>
                      <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                        <TextInput
                          value={pan_number}
