...
const EditAadharNumber = (props) => {
    ...
    const check_valid = () => {
        if (aadhar_number) {
            ...
            dropDownAlertRef.alertWithType('error', t('validationError'), t('pleaseEnterIDProof'));
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            data: { staff_id: global.id, aadhar_number: aadhar_number }
        })
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', t('successfullyUpdated'), t('IDproofUpdated'));
                go_back();
            })
            .catch(error => {
                setLoading(false);
     ...
     <>
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontWeight: 'normal' }}>{t('needEnterIDproof')}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
