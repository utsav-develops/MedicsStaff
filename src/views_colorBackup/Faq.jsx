        ...
        return (
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 30, alignItems: 'center' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_30, letterSpacing: 1, fontWeight: 'bold', textAlign: 'center' }}>{t('howHelp')}</Text>
                </View>
            </View>
        )
    }
