...
const RegisterReducer = (state = { phone_number:undefined, phone_with_code:undefined, country_code:undefined, first_name:undefined, last_name:undefined, email:undefined, licence_number:undefined, date_of_birth:undefined, referral_code:undefined }, action) => {
    switch (action.type) {
        ...
        case Actions.UPDATE_REFERRAL_CODE:
            return Object.assign({}, state, {
